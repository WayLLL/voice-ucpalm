...
public class ArrayUtil {
	...
	public static <T> T[] rtrim(T[] arr) {
		...
		return ret.toArray((T[]) Array.newInstance(arr.getClass().getComponentType(), 0));
	}
	 ...
	 * <li>若对象为{@link java.util.Collection}，则使用
	 * {@link java.util.Collection#toArray}进行转换；
